...
describe('JAVASCRIPT III', function () {
   describe('devolverPrimerElemento(array)', function () {
      xit('Debe retornar el primer elemento del arreglo', function () {
   ...
   describe('devolverUltimoElemento(array)', function () {
      xit('Debe retornar el último elemento del arreglo', function () {
   ...
   describe('obtenerLargoDelArray(array)', function () {
      xit('Debe retornar la longitud del arreglo', function () {
   ...
   describe('incrementarPorUno(array)', function () {
      xit('Debe retornar el arreglo con cada elemento aumentado en +1', function () {
   ...
   describe('agregarItemAlFinalDelArray(array, elemento)', function () {
      xit('Debe retornar el arreglo con el elemento agregado al final', function () {
   ...
   describe('agregarItemAlComienzoDelArray(array, elemento)', function () {
      xit('Debe retornar el arreglo con el elemento agregado al comienzo', function () {
   ...
   describe('dePalabrasAFrase(palabras)', function () {
      xit('Debe retornar un string con las palabras separadas por un espacio', function () {
   ...
   describe('arrayContiene(array, elemento)', function () {
      xit('Debe retornar True si el arreglo contiene el elemento', function () {
         expect(arrayContiene([10, 10, 16, 12], 10)).toBe(true);
      });
      xit('Debe retornar False si el arreglo NO contiene el elemento', function () {
   ...
   describe('agregarNumeros(arrayOfNums)', function () {
      xit('Debe retornar la suma de todos los números del arreglo', function () {
   ...
   describe('promedioResultadosTest(resultadosTest)', function () {
      xit('Debe retornar el promedio de todas las notas', function () {
   ...
   describe('numeroMasGrande(arrayOfNums)', function () {
      xit('Debe retornar el número más grande del arreglo', function () {
   ...
   describe('multiplicarArgumentos()', function () {
      xit('Debe retornar el producto de los argumentos', function () {
   ...
   describe('cuentoElementos(array)', function () {
      xit('Debe retornar la cantidad de elementos mayores a a 18', function () {
   ...
   describe('diaDeLaSemana(numeroDeDia)', function () {
      xit('Debe retornar "Es dia laboral" dependiendo del número del día', function () {
         expect(diaDeLaSemana(3)).toBe('Es dia laboral');
         expect(diaDeLaSemana(2)).toBe('Es dia laboral');
      });
      xit('Debe retornar "Es fin de semana" dependiendo del número del día', function () {
   ...
   describe('EXTRA CREDIT | continueStatement(num)', function () {
      it('Debe retornar un arreglo con los valores resultantes de incrementarlos en 2 siempre que el número y la xiteración seas diferentes a 5', function () {
